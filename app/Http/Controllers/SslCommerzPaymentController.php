...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data['cus_add1'] = $user->address ?? 'demo';
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "";
        $post_data['cus_phone'] = $user->phone ?? $this->random_number(11);
        $post_data['cus_fax'] = "";
    ...
    {
        $user = User::where('id', $request->value_d)->value('id');
