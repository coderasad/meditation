<section class="py-70">
    <div class="container">
        <div class="filtering-btn">
            ...
            <button type="button" class="ps-700 c00 s23" data-filter=".books">Books</button>
            <button type="button" class="ps-700 c00 s23" data-filter=".clothes">Clothes</button>
            <button type="button" class="ps-700 c00 s23" data-filter=".others">Others</button>
        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix books">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">450 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix clothes">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">250 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix others">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">150 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix books">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">440 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix others">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">560 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix others">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">130 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix clothes">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">230 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix clothes">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">430 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix others">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">90 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix others">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">650 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mix others">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix others">
                <div class="shop">
                    ...
                    <div class="shop-text tc">
                        ...
                        <p class="ps-400 c00 s16">40 Taka</p>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="shop-btn">
                    <a href="javascript:void(0)" class="secondary-btn cff mx-auto">See More</a>
                </div>
            </div>
        </div>
    </div>
