...
<section class="gellary-section py-100">
    <div class="container">
                        ...
                        <div class="featured-events-content">
                            ...
                            <div class="featured-events-desc">
                                <p class="ps-400 s16 c51">
                                    {{  substr($upcoming_event->description, 0, 80)  }} {{strlen($upcoming_event->description) > 80 ? '...':''}}
                                </p>
        ...
        <h2 class="ps-700 font-24 c00 mt-5 pt-5">All Event</h2>
        <div class="row gx-4 gy-5 mix-filter">
                        ...
                        <div class="featured-events-content">
                            ...
                            <div class="featured-events-desc">
                                <p class="ps-400 s16 c51 height-50">
                                    {{  substr($all_event->description, 0, 80)  }} {{strlen($all_event->description) > 80 ? '...':''}}
                                </p>
                            </div>
                            <div class=" event-desc-1">
