<section class="testimonial-section pt-50 pb-100">
    <div class="container p-relative">
        <div class="testimonial-title title-margin">
        ...
        <div class="position-relative">
                        ...
                        <div class="swiper-slide">
                            <div class="session  rounded-tt">
                                <div class="testimonial-img text-center ">
                                    <img src="{{ asset($testimonial->image) }}" alt="session" class="w-100 h-100">
                                </div>
                                <div class="testimonial-content text-center">
                                    <div class="session-desc pt-2">
                                        <p class="ps-400 s16 c51 testimonial-text">
                                            {{Str::limit($testimonial->description,110)}}
                                        </p>
                                        <hr>
                                        <div class="pb-5">
                                            <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="d-none d-sm-block">
                <div class="swiper-btn d-flex justify-content-between">
                    <button type="button"
                            class="circle d-flex justify-content-center align-items-center swiper-prev-testi">
                        <img src="{{ asset('') }}asset/frontend/svg-icon/arrow-left.svg" alt="arrow right" class="">
                    </button>
                    <button type="button"
                            class="circle d-flex justify-content-center align-items-center swiper-next-testi">
