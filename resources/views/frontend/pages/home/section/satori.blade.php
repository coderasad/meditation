<section class="satori-section pt-100 pb-100" id="meditations">
    <div class="container p-relative">
        ...
        <div class="position-relative">
            ...
            <div class="swiper-btn courses-swiper-btn d-flex justify-content-between">
                <button type="button"
                        class="circle d-flex justify-content-center align-items-center swiper-prev-satori-swiper-container">
                    <img src="{{ asset('') }}asset/frontend/svg-icon/arrow-left.svg" alt="arrow right" class="">
                </button>
                <button type="button"
                        class="circle d-flex justify-content-center align-items-center swiper-next-satori-swiper-container">
